  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-4 gap-1.5 mb-2.5">
        <StatCard icon={Users} label={mt("common.students", lang)} value={59} color="text-gray-600" bg="bg-gray-100" />
              ...
              {CLASSES.map((c, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    <span className="text-[9px] font-bold text-gray-700">{c.next}</span>
                    {i === 0 && (
                      <span className="text-[7px] font-bold text-emerald-600 px-1 py-0.5 bg-emerald-50 rounded">{lang === "vi" ? "KẾ TIẾP" : "NEXT"}</span>
                    )}
                  </div>
                </div>
              ))}
          ...
          >
            <div className="space-y-1">
              {[
                ...
                <div key={t.label} className="flex items-center gap-1.5 py-1 px-1.5 rounded-md bg-gray-50">
