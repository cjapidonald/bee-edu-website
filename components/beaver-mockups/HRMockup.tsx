  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-6 gap-1.5 mb-2.5">
        <StatCard icon={Users} label="Total" value={42} color="text-gray-600" bg="bg-gray-100" />
            ...
            <div className="divide-y divide-gray-100">
              {STAFF.map((s) => (
                ...
                >
                  ...
                  <span className="text-[9px] text-gray-600 truncate">{s.role}</span>
