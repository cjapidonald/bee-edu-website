...
export function FeaturePageTemplate({
  ...
  > = {
    en: {
      ...
      beforeAfterSubtitle: "See the difference Bee Education makes",
      without: "Without Bee Education",
      with: "With Bee Education",
      ctaTitle: "Ready to get started?",
      ctaSubtitle: "Join thousands of educators using Bee Education AI to work smarter.",
    ...
    "zh-HK": {
      ...
      beforeAfterSubtitle: "看看 Bee Education 帶來的改變",
      without: "沒有 Bee Education",
      with: "使用 Bee Education",
      ctaTitle: "準備好開始了嗎？",
      ctaSubtitle: "加入數千名教育工作者，使用 Bee Education AI 更聰明地工作。",
      talkToSales: "聯絡銷售",
      signUpFree: "聯絡銷售",
    },
  };
