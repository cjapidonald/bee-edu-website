      ...
      <div className="relative rounded-2xl overflow-hidden mb-2.5 p-3 bg-gradient-to-br from-[#FDB714] via-[#FF6B9D] to-[#E83B5E] text-gray-900 shadow-lg">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[9px] uppercase tracking-wider text-gray-900/80 font-semibold">
              Gem Wallet
            </div>
            <div className="flex items-baseline gap-2 mt-0.5">
              ...
              <span className="text-[9px] text-gray-900/80">gems · +12 today</span>
            </div>
            <div className="flex items-center gap-2 mt-1">
              <div className="flex items-center gap-0.5 px-1 py-0.5 bg-white/15 rounded">
                <Flame className="h-2 w-2 text-gray-900" />
              ...
              <div className="flex items-center gap-0.5 px-1 py-0.5 bg-white/15 rounded">
                <Star className="h-2 w-2 text-gray-900 fill-white" />
              ...
              {GAMES.map((g) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Play className="h-2 w-2 text-gray-900 fill-white" />
                    </button>
                  </div>
                  {/* Info */}
                  <div className="p-1.5">
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-2 p-1.5 rounded-lg border ${
                      canAfford ? "border-gray-100 bg-white" : "border-gray-100 bg-gray-50/50 opacity-70"
                    }`}
                  >
