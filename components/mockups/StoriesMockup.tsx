    ...
    >
      ...
      <div className="grid grid-cols-5 gap-2.5">
        ...
        <div className="col-span-3 space-y-2">
          {/* New post composer */}
          <div className="rounded-2xl bg-white border border-gray-200 p-2.5 shadow-sm">
            <div className="flex items-start gap-2">
              <MockAvatar name="Ms Nguyen" size={24} gradientFrom="#FDB714" gradientTo="#E83B5E" />
              <div className="flex-1">
                <div className="px-2 py-1.5 bg-gray-50/50 rounded-lg text-[9px] text-gray-500">
          ...
          {STORIES.map((s, i) => (
            ...
            >
              ...
              <div className="px-2.5 py-1.5">
                <div className="text-[9px] text-gray-600 leading-snug">{s.text}</div>
              </div>
              ...
              <div className="flex items-center gap-3 px-2.5 py-1.5 border-t border-gray-100">
                ...
                <div className="flex items-center gap-1 text-[8px] text-gray-500 ml-auto">
