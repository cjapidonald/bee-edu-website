...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const titles: Record<string, string> = {
    en: "About Bee Education AI | Bee Education AI",
    "zh-HK": "關於 Bee Education AI | Bee Education AI",
  };
  const descriptions: Record<string, string> = {
    en: "Learn about Bee Education AI—our mission, values, and how we help schools run smarter with AI.",
    "zh-HK": "了解 Bee Education AI 的使命與價值，以及我們如何以 AI 協助學校更高效運作。",
  };
  ...
  const texts = {
    en: {
      story: {
        title: "Our Story",
        paragraphs: [
          "Bee Education AI was founded on a simple yet powerful belief: that every educator deserves tools that work as hard as they do.",
      ...
      platform: {
        ...
        todayText: "Today, Bee Education AI has evolved into a comprehensive multi-tenant school management platform, serving schools with",
    ...
    "zh-HK": {
      story: {
        title: "我們的故事",
        paragraphs: [
          "Bee Education AI 的創立基於一個簡單而有力的信念：每位教育者都值得擁有與他們同樣努力工作的工具。",
      ...
      platform: {
        ...
        todayText: "如今，Bee Education AI 已發展成為綜合性的多租戶學校管理平台，為學校提供",
      ...
      ceo: {
        title: "Donald Cjapi",
        signature: "首席執行官",
        message: "作為一名對教育充滿熱情的軟體工程師，我創立了 Bee Education AI，以彌合強大技術與日常課堂需求之間的差距。我們致力於綠色可持續的 AI——構建工具將學校管理數碼化，使機構更高效，帶領它們邁入教育的下一階段。我們的平台代表了多年與教育者合作構建真正具有變革性事物的成果。",
      },
    },
  };
